#!/usr/bin/env python3
"""Train a simple MobileNetV3-Small presence classifier for Stage 1."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data-dir", default="datasets/raw/person")
    parser.add_argument("--output-dir", default="artifacts/stage1/models/mobilenet_seed")
...
def main() -> int:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        val_loss, val_acc = evaluate(model, val_loader, args.device, criterion)
        history.append(
            {
                "epoch": epoch,
